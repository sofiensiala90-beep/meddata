    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[100] p-4" onClick={onClose}>
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <header className="p-4 border-b border-slate-200 dark:border-slate-700">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Conditions d’utilisation – DASS</h3>
        </header>
        <main className="p-6 space-y-4 overflow-y-auto">
          <h4 className="font-bold text-slate-800 dark:text-slate-200">1. Utilisation responsable</h4>
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Vous vous engagez à utiliser DASS uniquement à des fins pédagogiques et scientifiques. Toute utilisation abusive, frauduleuse ou contraire à l’éthique médicale est strictement interdite.
          </p>

          <h4 className="font-bold text-slate-800 dark:text-slate-200">2. Propriété intellectuelle</h4>
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Les formulaires, analyses et contenus générés par l’IA sont protégés par les droits de propriété intellectuelle. Vous ne pouvez pas revendre, redistribuer ou reproduire tout ou partie du contenu de DASS sans autorisation écrite préalable.
          </p>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            DASS peut utiliser les données des formulaires à des fins statistiques, de recherche, d’amélioration des services ou de développement scientifique.
          </p>
          <p className="text-sm text-slate-600 dark:text-slate-400">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            DASS peut regrouper, analyser et commercialiser ces données statistiques anonymisées auprès de partenaires académiques, industriels ou institutionnels, dans le strict respect de l’anonymat et des réglementations en vigueur.
          </p>
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Les analyses générées par les utilisateurs à partir de leurs propres formulaires restent leur propriété exclusive et ne seront jamais exploitées par DASS sans accord explicite.
          </p>

          <h4 className="font-bold text-slate-800 dark:text-slate-200">6. Évolution du service</h4>
          <p className="text-sm text-slate-600 dark:text-slate-400">
            DASS se réserve le droit de modifier ses fonctionnalités, ses tarifs ou ses conditions d’utilisation à tout moment. Les utilisateurs seront notifiés de tout changement majeur affectant leurs droits ou leur expérience.
          </p>
