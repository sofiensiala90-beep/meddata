...
const Students: React.FC = () => {
  const {
    ...
    forms,
    responses,
    handleSendNotification, // onSendNotification
    handleUpdateUserStatus, // onUpdateUserStatus
    handleAdminCoinAdjustment, // onAdminCoinAdjustment
    handleUnvalidateForm // onUnvalidateForm
  } = useData();

  // Aliases for compatibility
  const onSendNotification = handleSendNotification;
  const onUpdateUserStatus = handleUpdateUserStatus;
  const onAdminCoinAdjustment = handleAdminCoinAdjustment;
  const onUnvalidateForm = handleUnvalidateForm;
