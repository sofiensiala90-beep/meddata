...
const Dashboard: React.FC = () => {
    ...
    const { forms, responses, users, transactions } = useData();
    ...
    if (currentUser.role === 'admin') {
        ...
        return (
            <div className="space-y-6">
                <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Vue d'ensemble de la plateforme</h2>
    ...
    const isSuspended = currentUser.status.startsWith('suspended');

    return (
        <div className="space-y-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Bonjour, {currentUser.name.split(' ')[0]} !</h2>
                ...
                <Card className="!bg-red-50 dark:!bg-red-900/20 border border-red-200 dark:border-red-800">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            {currentUser.status === 'suspended_manual' ? (
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <StatCard
                            ...
                            value={currentUser.coinBalance.toLocaleString()}
                            icon={<CoinIcon className="h-6 w-6 text-yellow-500 dark:text-yellow-400" />}
                        />
                        <StatCard
